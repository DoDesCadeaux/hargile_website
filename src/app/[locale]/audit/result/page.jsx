            ...
            <div className="max-w-6xl mx-auto !px-4 !py-12 sm:!px-6 lg:!px-8 container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                        <div className="space-y-3 container !mx-auto">
                            ...
                            <ul className="space-y-2 text-gray-300">
                                ...
                                <li className="flex items-center">
                                    ...
                                    <span className="font-medium">{formData.email != null ? formData.email : 'N/A'}</span>
                                </li>
                                <li className="flex items-center">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="!mt-6 flex">
                                <button className="flex items-center bg-violet-600 hover:bg-violet-700 !px-4 !py-2 rounded-md transition-colors text-sm font-medium cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 !mr-2 !my-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="!mb-12">
                    <div className="flex items-center !mb-6">
                        ...
                        <div className="!ml-4 !px-3 !py-1 !mb-3 bg-violet-600/20 rounded-full border border-violet-600 text-violet-400 text-sm font-medium">
                            Lighthouse v7
                        </div>
                    </div>
                            ...
                            <div key={index} className="backdrop-blur-md bg-gray-900/60 rounded-xl !p-6 border border-gray-800 shadow-lg transition-transform hover:transform hover:scale-105">
                                <div className="flex justify-between items-center !mb-4">
                                    <div className="flex items-center content-center">
                                        <div className="!mr-3 h-8 w-8 rounded-md bg-violet-600/20 flex items-center justify-center">
                    ...
                    {[
                        ...
                        <div key={index} className="backdrop-blur-md bg-gray-900/60 rounded-xl !p-6 border border-gray-800 shadow-lg !my-5">
                            <div className="flex items-center !mb-4">
                                <div className="!mr-3 h-10 w-10 rounded-md bg-violet-600/20 flex items-center justify-center">
                            ...
                            <div className="!mt-4 !p-3 rounded-md bg-red-900/20 border border-red-800">
                                <p className="text-red-400 text-sm !my-2">
                                    A score like {section.score < 90 ? section.score : 82}% may look okay, but it still indicates
                ...
                {/* CTA Section */}
                <div className="!mt-12 backdrop-blur-md bg-violet-600/10 rounded-xl !p-8 border border-violet-800/50 shadow-lg">
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div className="!mb-6 md:!mb-0">
                            <h3 className="text-2xl font-bold text-white !mb-2">Want to improve your scores?</h3>
                            <p className="text-violet-300">Our team of experts can help optimize your website for better performance, SEO, and accessibility.</p>
                        </div>
                        <div className="flex space-x-4">
                            <button className="bg-white text-violet-900 hover:bg-gray-100 !px-6 !py-3 !mx-2 rounded-md font-medium transition-colors cursor-pointer">
                                Contact Us
                            </button>
                        </div>
                    </div>
